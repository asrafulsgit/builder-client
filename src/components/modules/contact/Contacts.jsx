            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mt-12">
                <div className="max-w-80 bg-black text-white rounded-2xl">
                    ...
                    <div className="px-4 pb-6 text-center">
                        ...
                        <p className="text-sm font-medium bg-linear-to-r from-[#8B5CF6] via-[#9938CA] to-[#E0724A] text-transparent bg-clip-text">Content Marketing</p>
                    </div>
                </div>
                <div className="max-w-80 bg-black text-white rounded-2xl">
                    <div className="relative -mt-px overflow-hidden rounded-2xl">
...
export const contactComponents = [
   {id : "contact-1", name: "Contact 1", component: Contact1 },
  {id : "contact-2", name: "Contact 2", component: Contact2 },
]
